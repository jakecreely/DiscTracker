...
urlpatterns = [
    ...
    # ex: /items/1
    path("<str:cex_id>/", views.detail, name="detail"),
    path("<str:cex_id>/chart", views.item_price_chart, name="item-price-chart"),
    ...
    path("<str:cex_id>/delete", views.delete_item, name="delete-item"),
